...
app.controller('homepage.video' , function($scope,  $location, $filter){
  ...
  $scope.videoplayer=[
    ...
    {video:'bus.ogg',id:7,detail:"video7"},
    {video:'big_buck_bunny.ogv',id:8,detail:"video8"},
    {video:'big_buck_bunny.ogv',id:8,detail:"video9"}
  ]

});
app.controller('homepage.canvas',function($scope,$http) {
...
$scope.eraserSmall = function(){
  $scope.canvas.isDrawingMode = !$scope.canvas.isDrawingMode;
      ...
      $scope.canvas.freeDrawingBrush.color = ' 	#F0F0F0';
        $scope.canvas.renderAll();
    ...
    $scope.eraserLarge = function(){
      $scope.canvas.isDrawingMode = !$scope.canvas.isDrawingMode;
         $scope.canvas.freeDrawingBrush.width = 25;
          $scope.canvas.freeDrawingBrush.color = 's#F0F0F0';
            $scope.canvas.renderAll();
